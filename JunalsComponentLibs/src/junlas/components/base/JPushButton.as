package junlas.components.base
{
	...
	public class JPushButton extends JComponent
	{
		 ...
		 */
		public function JPushButton(parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number =  0, label:String = "", defaultHandler:Function = null)
		{
			super(parent, xpos, ypos);
			if(defaultHandler != null)
			{
				_defaultHandler = defaultHandler;
				addEventListener(MouseEvent.CLICK, _defaultHandler);
			}
			this.label = label;
		}
		...
		protected function drawFace():void
		{
			...
			if(_down)
			{
				_face.graphics.beginFill(JStyle.BUTTON_DOWN);
			}
			else
			{
				_face.graphics.beginFill(JStyle.BUTTON_FACE);
			}
		...
		override public function draw():void
		{
			...
			_back.graphics.beginFill(JStyle.BACKGROUND);
		...
		override public function destroy():void{
			_defaultHandler && removeEventListener(MouseEvent.CLICK, _defaultHandler);
			_defaultHandler && removeEventListener(MouseEvent.CLICK, _defaultHandler);
